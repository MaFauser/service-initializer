...
class ExampleServiceTest {
    ...
    @Test
    fun `findAll returns all examples from repository`() {
        val examples =
            listOf(
                Example(name = "One"),
                Example(name = "Two"),
    ...
    @Test
    fun `findById returns example when found`() {
        val id = UUID.randomUUID()
    ...
    @Test
    fun `create saves and returns new example`() {
    ...
    @Test
    fun `create throws DuplicateExampleNameException when name exists`() {
    ...
    @Test
    fun `update updates and returns example`() {
        val id = UUID.randomUUID()
    ...
    @Test
    fun `update throws ExampleNotFoundException when not found`() {
        val id = UUID.randomUUID()
        whenever(exampleRepository.findById(id)).thenReturn(Optional.empty())
    ...
    @Test
    fun `update throws DuplicateExampleNameException when new name already exists`() {
        val id = UUID.randomUUID()
    ...
    @Test
    fun `update keeps same name without duplicate check`() {
        val id = UUID.randomUUID()
    ...
    @Test
    fun `delete returns true when example exists`() {
        val id = UUID.randomUUID()
    ...
    @Test
    fun `delete returns false when example does not exist`() {
        val id = UUID.randomUUID()
